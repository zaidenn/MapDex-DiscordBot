...
ALTER TABLE "special" DROP COLUMN "monarchy_card";
ALTER TABLE "special" DROP COLUMN "theocracy_card";
...
INSERT INTO "regime" ("name", "background") VALUES
    ...
    ('Monarchy', '/ballsdex/core/image_generator/src/monarchy.png'),
    ('Theocracy', '/ballsdex/core/image_generator/src/theocracy.png');
...
ALTER TABLE "special" ADD "monarchy_card" VARCHAR(200);
ALTER TABLE "special" ADD "theocracy_card" VARCHAR(200);
