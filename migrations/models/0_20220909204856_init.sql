...
COMMENT ON COLUMN "ball"."health" IS 'Map health stat';
COMMENT ON COLUMN "ball"."attack" IS 'Map attack stat';
COMMENT ON COLUMN "ball"."rarity" IS 'Rarity of this map';
COMMENT ON COLUMN "ball"."emoji_id" IS 'Emoji ID for this map';
COMMENT ON COLUMN "ball"."wild_card" IS 'Image used when a new map spawns in the wild';
COMMENT ON COLUMN "ball"."collection_card" IS 'Image used when displaying maps';
COMMENT ON COLUMN "ball"."credits" IS 'Author of the collection artwork';
COMMENT ON COLUMN "ball"."capacity_name" IS 'Name of the map''s capacity';
COMMENT ON COLUMN "ball"."capacity_description" IS 'Description of the map''s capacity';
...
COMMENT ON COLUMN "guildconfig"."spawn_channel" IS 'Discord channel ID where maps will spawn';
COMMENT ON COLUMN "guildconfig"."enabled" IS 'Whether the bot will spawn maps in this guild';
