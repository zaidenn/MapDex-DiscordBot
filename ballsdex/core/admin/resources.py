...
class SpecialResource(Model):
    ...
    fields = [
        ...
        Field(
            ...
            input_=inputs.Date(help_text="Date when special maps will start spawning"),
        ),
        Field(
            name="end_date",
            label="End date of the event",
            display=displays.DateDisplay(),
            input_=inputs.Date(help_text="Date when special maps will stop spawning"),
        ),
        "rarity",
        Field(
            name="background",
...
class BallInstanceResource(Model):
    ...
    model = BallInstance
    icon = "fas fa-atlas"
    page_pre_title = "map instances list"
    page_title = "Map Instances"
    filters = [
        filters.Search(
            name="id",
            label="Map Instance ID",
            placeholder="Search for map IDs",
        ),
        filters.ForeignKey(model=Ball, name="map", label="Map"),
        filters.Search(
