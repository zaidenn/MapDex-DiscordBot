...
class Info(commands.Cog):
    ...
    async def about(self, interaction: discord.Interaction):
        ...
        try:
            ...
            log.error("Failed to fetch 10 maps emotes", exc_info=True)
            balls = []
        ...
        embed.description = (
            ...
            "This bot was made by **El Laggron** and forked by **tezmeon**, consider supporting him on his "
            ...
            f"[Vote for us]({settings.vote_link})"
        )
