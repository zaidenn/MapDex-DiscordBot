...
class Settings:
    ...
    collectible_name: str
        Usually "map", can be replaced when possible
    bot_name: str
        Usually "MapDex", can be replaced when possible
    players_group_cog_name: str
        Set the name of the base command of the "players" cog, /maps by default
    ...
    collectible_name: str = "map"
    bot_name: str = "MapDex"
    players_group_cog_name: str = "maps"
...
def read_settings(path: "Path"):
    ...
    settings.vote_link = content["about"]["vote-link"]
...
about:
  ...
  description: >
    Collect maps on Discord, exchange them and battle with friends!

  # override this if you have a fork
  github-link: https://github.com/zaidenn/MapDex-DiscordBot

  # valid invite for a Discord server
  discord-invite: https://discord.gg/jYEzGdzBPN  # MapDex official server

  terms-of-service: https://gist.github.com/zaidenn/a85bfbc3fb3fbfe8ea2124d43da1a6c5
  privacy-policy: https://gist.github.com/zaidenn/b8f67602b17e097a2efeb59151fd7715

  # bot vote link on a bot listing website
  vote-link: https://top.gg/bot/1143236933921808404/vote

# WORK IN PROGRESS, DOES NOT FULLY WORK
# override the name "map" in the bot
collectible-name: map

# WORK IN PROGRESS, DOES NOT FULLY WORK
# override the name "MapDex" in the bot
bot-name: MapDex

# players group cog command name
# this is /maps by default, but you can change it for /animals or /rocks for example
players-group-cog-name: maps
